    ...
    const mockConversations: Conversation[] = [
      {
        ...
        last_message: {
          ...
          sender_id: 'user-2',
          message_type: 'text',
          content: 'J\'ai trouvé une vulnérabilité dans le protocole, on en discute ?',
          metadata: {},
          client_random: 12345,
      ...
      },
      {
        ...
        last_message: {
          ...
          sender_id: 'user-4',
          message_type: 'text',
          content: 'Le déploiement de la nouvelle version est prévu pour demain',
          metadata: {},
          client_random: 12347,
      ...
      },
      {
        ...
        last_message: {
          ...
          sender_id: 'user-8',
          message_type: 'text',
          content: 'Penetration test terminé, 3 vulnérabilités critiques trouvées',
          metadata: {},
          client_random: 12351,
      ...
      },
      {
        ...
        last_message: {
          ...
          sender_id: 'user-9',
          message_type: 'text',
          content: 'Smart contract audit en cours, résultats attendus demain',
          metadata: {},
          client_random: 12352,
