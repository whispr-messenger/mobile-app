...
import { AppResetService } from "../../services";
...
export const SettingsScreen: React.FC = () => {
  ...
  const handleResetApp = () => {
    Alert.alert(
      ...
      "Cela supprime les comptes en local (session, caches, clés) sur cet appareil. Continuer ?",
      [
        { text: getLocalizedText("common.cancel"), style: "cancel" },
        {
          text: "Réinitialiser",
      ...
      >
        ...
        >
          ...
          <SettingItem
            ...
            subtitle="Supprime la session et les données locales"
