/**
 * Mon QR code — partage du profil (WHISPR-216)
 */
  ...
  const loadQRCode = async () => {
    try {
      ...
      if (!qrData) {
        Alert.alert(
          "Erreur",
          "Impossible de générer le QR code. Veuillez vous reconnecter.",
        );
        navigation.goBack();
        return;
      }
        ...
        >
          {loading ? (
            ...
            >
              <View style={styles.userCard}>
                ...
                <Text
                  style={[
                    ...
                    { color: colors.text.light, opacity: 0.7 },
                  ]}
                >
              ...
              <Animated.View
                style={[styles.qrCard, { transform: [{ scale: qrPulseAnim }] }]}
              >
                <LinearGradient
              ...
              <View style={styles.actionsContainer}>
                <Animated.View
                  style={{ flex: 1, transform: [{ scale: buttonShareAnim }] }}
                >
                  <TouchableOpacity
                    onPress={handleShare}
                    activeOpacity={0.85}
                ...
                <Animated.View
                  style={{ flex: 1, transform: [{ scale: buttonSaveAnim }] }}
                >
                  <TouchableOpacity
              ...
              <View style={styles.infoContainer}>
                ...
                >
                  Partagez ce QR code avec vos amis pour qu&apos;ils puissent
                  vous ajouter facilement
                </Text>
              </View>
            </Animated.View>
          ) : (
...
const styles = StyleSheet.create({
  ...
  saveButton: { backgroundColor: "transparent" },
  actionButtonText: {
    fontSize: 17,
    fontWeight: "700",
    letterSpacing: 0.3,
