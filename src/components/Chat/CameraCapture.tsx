                ...
                >
                  <View style={styles.header}>
                    ...
                    >
                      <LinearGradient
                        colors={[
                          withOpacity(colors.ui.error, 0.3),
                          withOpacity(colors.ui.error, 0.1),
                        ]}
                    ...
                    >
                      {capturedMedia.type === "image" ? (
                        ...
                        >
                          ...
                          <Text style={styles.videoLabel}>Vidéo capturée</Text>
                        </LinearGradient>
                      )}
