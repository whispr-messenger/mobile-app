...
const localizedTexts: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'auth.noAccountFound': 'Aucun compte trouvé pour ce numéro. Voulez-vous vous inscrire ?',
    'auth.accountAlreadyExists': 'Un compte existe déjà avec ce numéro. Voulez-vous vous connecter ?',
  ...
  en: {
    ...
    'auth.noAccountFound': 'No account found for this number. Would you like to register?',
    'auth.accountAlreadyExists': 'An account already exists with this number. Would you like to log in?',
